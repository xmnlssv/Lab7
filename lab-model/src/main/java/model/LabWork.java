...
public class LabWork implements Serializable, Comparable<LabWork> {
    ...
    /**
     * The userLogin of the author. Cannot be null.
     */
    ...
    public LabWork(Integer id, String name, Coordinates coordinates, ZonedDateTime creationDate, double minimalPoint,
                   Difficulty difficulty, Person author, String login) {
        this.id = id;
        this.name = name;
    ...
    @XmlElement
    /**
     * Returns the user login of the Author.
     *
     * @return The user login of the Author.
     */
    ...
    /**
     * Sets the user login of the Author.
     *
     * @param user login the author of the Author.
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(login, labWork.login)) return false;
    ...
    public static class LabWorkBuilder {
        ...
        public LabWorkBuilder login(String login) {
            this.login = login;
            return this;
        }
    }
